...
function headerControl() {
  if ($(window).scrollTop() > 100) {
    $('body').addClass('pre-header-fixed');
    ...
    $('body').removeClass('pre-header-fixed');
  }
}

// var func = headerControl;
var func = throttle(headerControl, 500);
  ...
  this.send = function () {
    $.ajax({
      ...
      if (JSON.parse(data).status == 'Success') {
        html = "\n          <div class=\"alert alert-success alert-dismissible fade show\" role=\"alert\">\n            <strong>\u9001\u4FE1\u3057\u307E\u3057\u305F\u3002</strong> \u3042\u308A\u304C\u3068\u3046\u3054\u3056\u3044\u307E\u3059\u3002\u306A\u308B\u3079\u304F\u65E9\u304F\u304A\u8FD4\u4E8B\u3055\u305B\u3066\u3044\u305F\u3060\u304D\u307E\u3059\u3002\n          </div>";
      } else {
        html = "\n          <div class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">\n            <strong>\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002</strong> \u7533\u3057\u8A33\u3042\u308A\u307E\u305B\u3093\u3002\u5F8C\u307B\u3069\u518D\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002\n          </div>";
      }
...
$(function () {
  $('#contact-form').on('submit', function (e) {
    e.preventDefault();
    var sendmail = new Sendmail($(this).serialize());
    sendmail.send();
